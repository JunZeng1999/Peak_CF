...
class BalancedPositiveNegativeSampler(object):
    ...
    def __call__(self, matched_idxs):
        ...
        pos_idx = []
        neg_idx = []
        # traverse matched_idxs on each image
        for matched_idxs_per_image in matched_idxs:
            ...
            # specify the number of positive samples
            num_pos = int(self.batch_size_per_image * self.positive_fraction)
            # protect against not enough positive examples
            num_pos = min(positive.numel(), num_pos)
            # specify the number of negative samples
...
class BoxCoder(object):
    ...
    def encode(self, reference_boxes, proposals):
        ...
        Args:
            reference_boxes: List[Tensor] gt_boxes corresponding to each proposal/anchor
    ...
    def decode(self, rel_codes, boxes):
        ...
        # apply the predicted bbox regression parameters to the corresponding
        # anchors to obtain the coordinates of the predicted Bbox
...
class Matcher(object):
    ...
    def __call__(self, match_quality_matrix):
        """
        iou<low_threshold:  index value = -1, low_threshold<=iou<high_threshold: index value = -2
        Args:
    ...
    def set_low_quality_matches_(self, matches, all_matches, match_quality_matrix):
        ...
        # highest_quality_foreach_gt indicates the maximum iou value
        ...
        pre_inds_to_update = gt_pred_pairs_of_highest_quality[1]
        # retain the index of anchor even if the iou is below the threshold
