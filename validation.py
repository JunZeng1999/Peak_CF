"""
This script is used to calculate the COCO metrics of the validation/test set
and the mAP of each category (IoU=0.5) using the trained model weights
"""
...
def main(parser_data):
    ...
    # the norm_layer is the same as in the training script
    ...
    # Load the weights of your own trained models
    ...
    # Save the verification result to txt file
...
if __name__ == "__main__":
    ...
    # the root directory of the dataset(VOCdevkit)
    parser.add_argument('--data-path', default='./', help='dataset root')

    # trained weight files
    parser.add_argument('--weights', default='./save_weights/resNetFpn-model.pth', type=str, help='training weights')
